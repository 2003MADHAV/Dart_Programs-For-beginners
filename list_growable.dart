...
void main() {
  ...
  List<int?> numbersList = List.empty(growable: true); // Growable List: METHOD 2
  ...
  numbersList[0] = 99;    // Update operation
  numbersList[1] = null;  // Delete operation (sets to null)

  print(numbersList[0]);

  numbersList.remove(99);    // Removing element
  numbersList.add(24);       // Adding element
  numbersList.removeAt(3);   // Removing element at index 3
